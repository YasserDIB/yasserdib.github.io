...
<script id="apple-pay-shop-capabilities" type="application/json">{"shopId":71263060253,"countryCode":"US","currencyCode":"USD","merchantCapabilities":["supports3DS"],"merchantId":"gid:\/\/shopify\/Shop\/71263060253","merchantName":"Bellabooty","requiredBillingContactFields":["postalAddress","email"],"requiredShippingContactFields":["postalAddress","email"],"shippingType":"shipping","supportedNetworks":["visa","masterCard","amex","discover","elo","jcb"],"total":{"type":"pending","label":"Bellabooty","amount":"1.00"},"shopifyPaymentsEnabled":true,"supportsSubscriptions":true}</script>
<script id="shopify-features" type="application/json">{"accessToken":"a44e5364e695d96f0a78263a93582aae","betas":["rich-media-storefront-analytics"],"domain":"bellabooty.com","predictiveSearch":true,"shopId":71263060253,"smart_payment_buttons_url":"https:\/\/cdn.shopify.com\/shopifycloud\/payment-sheet\/assets\/latest\/spb.en.js?v=2","dynamic_checkout_cart_url":"https:\/\/cdn.shopify.com\/shopifycloud\/payment-sheet\/assets\/latest\/dynamic-checkout-cart.en.js?v=2","locale":"en","optimusEnabled":false}</script>
<script>var Shopify = Shopify || {};
Shopify.shop = "bellabooty-1776.myshopify.com";
Shopify.locale = "en";
Shopify.currency = {"active":"USD","rate":"1.0"};
Shopify.country = "US";
Shopify.theme = {"name":"Dawn Theme (March 28th) with Installments message","id":146214453533,"theme_store_id":887,"role":"main"};
...
<script>(function() {
  function asyncLoad() {
    var urls = ["https:\/\/geolocation-recommendations.shopifyapps.com\/locale_bar\/script.js?shop=bellabooty-1776.myshopify.com","https:\/\/cdn.shopify.com\/s\/files\/1\/0712\/6306\/0253\/t\/7\/assets\/convert_global.js?v=1680194246\u0026shop=bellabooty-1776.myshopify.com","https:\/\/doui4jqs03un3.cloudfront.net\/checkout.js.gz?shop=bellabooty-1776.myshopify.com","https:\/\/cdn-app.cart-bot.net\/public\/js\/append.js?shop=bellabooty-1776.myshopify.com","https:\/\/cdn-bundler.nice-team.net\/app\/js\/bundler.js?shop=bellabooty-1776.myshopify.com","https:\/\/d1639lhkj5l89m.cloudfront.net\/js\/storefront\/uppromote.js?shop=bellabooty-1776.myshopify.com","https:\/\/cdn.rebuyengine.com\/onsite\/js\/rebuy.js?shop=bellabooty-1776.myshopify.com"];
...
<!-- End VWO Async SmartCode -->
  ...
  <!-- Google tag (gtag.js) -->
<script async src="https://www.googletagmanager.com/gtag/js?id=AW-446854373"></script>
<script>
  window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
  gtag('js', new Date());

  gtag('config', 'AW-446854373');
